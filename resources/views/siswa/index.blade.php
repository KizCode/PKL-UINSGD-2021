    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card border-secondary">
                <div class="card-header bg-success mb-3">Data Pegawai
                    <a href="{{ route('siswa.create') }}" class="btn btn-outline-success" style="float: right;">Add Data
                    </a>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="btn-group btn-group-sm">
                                        <a href="{{ route('siswa.edit', $data->id) }}" class="btn btn-info"><i class="nav-icon fas fa-edit"></i></a> |
                                        <a href="{{ route('siswa.edit', $data->id) }}" class="btn btn-warning"><i class="nav-icon fas fa-eye"></i></a> |
                                        <button type="submit" class="btn btn-danger" onclick="return confirm('Are You Sure?')"><i class="nav-icon fas fa-trash"></i></button>
