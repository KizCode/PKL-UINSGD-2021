                ...
                <div class="card-body p-4">
                    <form class="row g-2" action="{{ route('user.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 col-sm-6">
                            ...
                            <input id="nip" type="number" name="nip" class="form-control @error('nip') is-invalid @enderror" required>
                            @error('nip')
                        ...
                        <div class="mb-3 col-sm-6">
                            ...
                            <input id="name"  type="text" name="name" class="form-control @error('nip') is-invalid @enderror"  value="{{ old('name') }}" required>
                            @error('name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="mb-3 col-6">
                            ...
                            <input id="tl" type="date" name="tl"  class="form-control @error('tl') is-invalid @enderror"  value="{{ old('tl') }}" required>
                            @error('tl')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="mb-3 col-6">
                            ...
                            <select name="level" id="level" class="form-select @error('level') is-invalid @enderror" name="level" id="level" required>
                                <option selected disabled>
