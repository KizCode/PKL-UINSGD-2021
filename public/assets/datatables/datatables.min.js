...
(function(l) {
    ...
    function Jb(a) {
        ...
        for (b = g.length; k < b; k++) {
            ...
            h && n.appendTo(c);
            a.oFeatures.bSort &&
                (n.addClass(m.sSortingClass), !1 !== m.bSortable &&
                    (n
            ...
            for (d = h.length; k < d; k++) {
                ...
                for (b = h[k].length; e < b; e++) {
                    ...
                    if (f[k][e] === q) {
                        ...
                        for (
                            f[k][e] = 1; h[k + g] !== q && h[k][e].cell == h[k + g][e].cell;
    ...
    function Mb(a) {
        ...
        for (
            var h = a.sDom.split(""), f, g, k, m, n, p, t = 0; t < h.length; t++
        ) {
            f = null;
            g = h[t];
            if ("<" == g) {
    ...
    function Xb(a) {
        for (
            var b = u.ext.search, c = a.aiDisplay, d, e, h = 0, f = b.length; h < f; h++
        ) {
    ...
    var zb = function(a, b, c, d, e) {
        ...
        Ab = function(a) {
            ...
            return l.extend({ search: "none", order: "current", page: "all" },
                a
            );
        },
        Bb = function(a) {
